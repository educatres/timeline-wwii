...
const EVENTS = [
  {id:'a1935',region:'asia',year:1935,date:'1935',type:'leader',title:'中國國民政府的十年建設',summary:'南京國民政府持續推動交通、金融與行政整合，但國共對峙與日本壓力同步升高。',leaders:['蔣中正','汪精衛'],context:'國民政府試圖建立中央集權與現代財政體系，卻必須同時處理內戰、地方勢力與日本在華北的擴張。',impact:'觀察焦點：國家建設為何常與戰爭準備同時發生？',source:'https://history.state.gov/milestones/1937-1945/chinese-rev'},
  ...
  {id:'e1938',region:'europe',year:1938,date:'1938.09',type:'leader',title:'慕尼黑協定與綏靖政策',summary:'英法同意德國取得蘇台德區，希望以讓步避免戰爭。',leaders:['內維爾・張伯倫','阿道夫・希特勒','愛德華・達拉第'],context:'第一次世界大戰創傷、軍備不足與反戰民意影響決策；但讓步也削弱捷克斯洛伐克並鼓勵納粹進一步擴張。',impact:'外交難題：妥協何時是和平策略，何時成為縱容？',source:'https://encyclopedia.ushmm.org/content/en/article/munich-agreement'},
  ...
  {id:'m1945',region:'americas',year:1945,date:'1945',type:'leader',title:'羅斯福逝世，杜魯門接任',summary:'杜魯門在戰爭最後階段接掌總統職務，面對原子彈、戰後安排與蘇聯關係。',leaders:['哈瑞・杜魯門','富蘭克林・羅斯福'],context:'美國從戰時同盟核心轉向戰後超級強權；總統更替也使決策風格與資訊掌握出現急遽轉換。',impact:'領導人更替如何影響重大歷史決策？',source:'https://history.state.gov/milestones/1937-1945/potsdam-conf'},
